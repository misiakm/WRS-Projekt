...
Private Sub btnStawki_Click()
   DoCmd.openForm "DzialyPracownikow", , , "dzial = " & Me.ID
   Form_dzialyPracownikow.dzial.DefaultValue = Me.ID
End Sub

Private Sub btnUsun_Click()
   If MsgBox("Czy na pewno chcesz usunąć dział?", vbYesNo) = vbNo Then Exit Sub
   Call deleteRecord
End Sub
